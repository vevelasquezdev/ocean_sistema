...
<li id="menu_administracion"> {{-- active open --}}
    ...
    <ul>                    
        <li id="submenu_usuarios">
            <a href="{!! route('vwuser') !!}" title="Usuarios" data-filter-tags="usuarios">
        ...
        <li id="submenu_mesas">
            <a href="{!! route('admin-mesas.index') !!}" title="Ver Mesas" data-filter-tags="mesas">
                <span class="nav-link-text" >Mesas</span>
            </a>
        </li>                    
    </ul>
