@extends('layouts.app')
@section('titulo') Inventario - Principal Barra @endsection
...
<div class="row">
    <div class="col-md-12 col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    <span class="fw-300"><i>Inventario</i></span>&nbsp;&nbsp;Principal Barra 
                </h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="table-responsive">
                        <table id="tablaInvPrincipalBarra" class="table table-bordered table-hover table-striped w-100">
...
$(function () { 
    ...
    $("#submenu_principal_barra").addClass("active");  
    $('#fch').datepicker({
                    todayHighlight: true,
    ...
    var table = $('#tablaInvPrincipalBarra').DataTable({
        headers: {'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content') },
        processing: true,
        serverSide: true,
        responsive: true,
        ajax: "almacen-principal-barra?fch="+$("#fch").val(),            
        columns: [
...
function actualizar_tabla(){
    ...
    $('#tablaInvPrincipalBarra').DataTable().ajax.url("almacen-principal-barra?fch="+$("#fch").val()).load();
