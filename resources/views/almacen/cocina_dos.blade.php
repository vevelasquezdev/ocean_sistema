@extends('layouts.app')
@section('titulo') Inventario - Cocina Dos @endsection
...
<div class="row">
    <div class="col-md-12 col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    <span class="fw-300"><i>Inventario</i></span>&nbsp;&nbsp;Cocina Dos 
                </h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="table-responsive">
                        <table id="tablaInvCocinaDos" class="table table-bordered table-hover table-striped w-100">
...
$(function () { 
    ...
    $("#submenu_cocina_2").addClass("active");  
    $('#fch').datepicker({
                    todayHighlight: true,
    ...
    var table = $('#tablaInvCocinaDos').DataTable({
        headers: {'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content') },
        processing: true,
        serverSide: true,
        responsive: true,
        ajax: "almacen-cocina-dos?fch="+$("#fch").val(),        
        columns: [
...
function actualizar_tabla(){
    ...
    $('#tablaInvCocinaDos').DataTable().ajax.url("almacen-cocina-dos?fch="+$("#fch").val()).load();
