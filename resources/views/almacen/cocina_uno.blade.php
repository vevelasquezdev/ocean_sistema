@extends('layouts.app')
@section('titulo') Inventario - Cocina Uno @endsection
...
<div class="row">
    <div class="col-md-12 col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    <span class="fw-300"><i>Inventario</i></span>&nbsp;&nbsp;Cocina Uno 
                </h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="table-responsive">
                        <table id="tablaInvCocinaUno" class="table table-bordered table-hover table-striped w-100">
...
$(function () { 
    ...
    $("#submenu_cocina_1").addClass("active");  
    $('#fch').datepicker({
                    todayHighlight: true,
    ...
    var table = $('#tablaInvCocinaUno').DataTable({
        headers: {'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content') },
        processing: true,
        serverSide: true,
        responsive: true,
        ajax: "almacen-cocina-uno?fch="+$("#fch").val(),        
        columns: [
...
function actualizar_tabla(){
    ...
    $('#tablaInvCocinaUno').DataTable().ajax.url("almacen-cocina-uno?fch="+$("#fch").val()).load();
