@extends('layouts.app')
@section('titulo') Inventario - Barra Uno @endsection
...
<div class="row">
    <div class="col-md-12 col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    <span class="fw-300"><i>Inventario</i></span>&nbsp;&nbsp;Barra Uno 
                </h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="table-responsive">
                        <table id="tablaInvBarraUno" class="table table-bordered table-hover table-striped w-100">
...
$(function () { 
    ...
    $("#submenu_barra_1").addClass("active");  
    $('#fch').datepicker({
                    todayHighlight: true,
    ...
    var table = $('#tablaInvBarraUno').DataTable({
        headers: {'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content') },
        processing: true,
        serverSide: true,
        responsive: true,
        ajax: "almacen-barra-uno?fch="+$("#fch").val(),        
        columns: [
...
function actualizar_tabla(){
    ...
    $('#tablaInvBarraUno').DataTable().ajax.url("almacen-barra-uno?fch="+$("#fch").val()).load();
