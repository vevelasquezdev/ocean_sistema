@extends('layouts.app')
@section('titulo') Inventario - Principal Cocina @endsection
...
<div class="row">
    <div class="col-md-12 col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    <span class="fw-300"><i>Inventario</i></span>&nbsp;&nbsp;Principal Cocina 
                </h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="table-responsive">
                        <table id="tablaInvPrincipalCocina" class="table table-bordered table-hover table-striped w-100">
...
$(function () { 
    $("#menu_alm_invent_cocina").addClass("active open");
    $("#submenu_principal_cocina").addClass("active");  
    $('#fch').datepicker({
                    todayHighlight: true,
    ...
    var table = $('#tablaInvPrincipalCocina').DataTable({
        headers: {'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content') },
        processing: true,
        serverSide: true,
        responsive: true,
        ajax: "almacen-principal-cocina?fch="+$("#fch").val(),        
        columns: [
...
function actualizar_tabla(){
    ...
    $('#tablaInvPrincipalCocina').DataTable().ajax.url("almacen-principal-cocina?fch="+$("#fch").val()).load();
