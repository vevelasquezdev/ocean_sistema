@extends('layouts.app')
@section('titulo') Inventario - Barra Cuatro @endsection
...
<div class="row">
    <div class="col-md-12 col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    <span class="fw-300"><i>Inventario</i></span>&nbsp;&nbsp;Barra Cuatro
                </h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="table-responsive">
                        <table id="tablaInvBarraCuatro" class="table table-bordered table-hover table-striped w-100">
...
$(function () { 
    ...
    $("#submenu_barra_4").addClass("active");  
    $('#fch').datepicker({
                    todayHighlight: true,
    ...
    var table = $('#tablaInvBarraCuatro').DataTable({
        headers: {'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content') },
        processing: true,
        serverSide: true,
        responsive: true,
        ajax: "almacen-barra-cuatro?fch="+$("#fch").val(),        
        columns: [
...
function actualizar_tabla(){
    ...
    $('#tablaInvBarraCuatro').DataTable().ajax.url("almacen-barra-cuatro?fch="+$("#fch").val()).load();
