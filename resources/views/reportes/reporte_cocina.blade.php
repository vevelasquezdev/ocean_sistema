@extends('layouts.app')
@section('titulo') Reporte Cocina @endsection
...
<div class="row">
    <div class="col-md-12 col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    <span class="fw-300"><i>Reporte</i></span>&nbsp;&nbsp;Cocina 
                </h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <div class="form-row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-lg-3 form-label text-lg-right">Cocina:</label>&nbsp;
                                <div class="col-12 col-lg-8">
                                    <select id="txt_cocina_gral" class="form-control text-uppercase" required>
                                        <option value="0">Todo</option>
                                        <option value="1">COCINA_1</option>
                                        <option value="2">COCINA_2</option>
                        ...
                        <div class="col-md-2 mb-4">                           
                            <button onclick="actualizar_reporte_cocina();" type="button" class="btn btn-primary btn-sm btn-block waves-effect waves-themed">ACTUALIZAR</button> 
                        </div> 
                        <div class="col-md-2">
                            <div class="form-group row">
                    ...
                    <div class="table-responsive">
                        <table id="tableReportCocina" class="table table-bordered table-hover table-striped w-100">
...
$(function () { 
    ...
    var table = $('#tableReportCocina').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
